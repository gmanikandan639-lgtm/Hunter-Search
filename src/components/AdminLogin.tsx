    ...
    <div id="auth-page-container" className="w-full flex items-center justify-center py-6 px-4 sm:px-6">
      <div className="w-full max-w-md">
        ...
        >
          ...
          <div className="text-center space-y-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                {mode === 'login' && 'Sign in with your Google ID or enter your ID & password'}
                {mode === 'signup' && 'Create your ID & password to access Hunter Verification'}
                {mode === 'forgot' && 'Reset your password to regain account access'}
              </p>
            </div>
          </div>

          {/* Tab Switcher: Sign In vs Create ID & Password */}
          {mode !== 'forgot' && (
            <div
              id="auth-mode-tabs"
              className="flex items-center p-1 bg-slate-100/90 rounded-xl border border-slate-200"
            >
              <button
                id="tab-mode-login"
                type="button"
          ...
          {/* =============================================================== */}
          {/* MODE 2: SIGN UP (Create Account / ID & Password) */}
          {/* =============================================================== */}
          {mode === 'signup' && (
            <div className="space-y-4">
              ...
              >
                {isGoogleLoading ? (
                  ...
                  <>
                    ...
                    <span>Sign Up with Google ID</span>
                  </>
                )}
              </button>
              ...
              <form id="signup-form" onSubmit={handleEmailSignUp} className="space-y-3.5">
                ...
                >
                  {isLoading ? (
                    <div className="flex items-center gap-2">
                      <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
                      <span>Creating ID & Password...</span>
                    </div>
                  ) : (
                ...
                <div className="pt-2 text-center border-t border-slate-100">
                  <span className="text-xs text-slate-500">Already have an ID? </span>
                  <button
